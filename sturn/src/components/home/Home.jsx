...
<section className="relative w-full overflow-hidden py-32">
  {/* Fondo con gradiente (de la Opción 1) */}
  ...
  <div className="max-w-7xl mx-auto px-4 relative z-10">
    ...
    >
      {/* Badge (de la Opción 1) */}
      <Badge variant="secondary" className="mb-4 hover:bg-primary/10 transition-colors">
        Cuidando sonrisas desde 2010
      </Badge>
  ...
  {[
    ...
    <motion.div
      ...
      className="flex flex-col items-center text-center" // Cambio clave aquí
    >
      <div className="bg-primary/10 p-4 rounded-full w-16 h-16 flex items-center justify-center mb-3">
        {item.icon}
      </div>
      <p className="text-sm font-medium w-full px-2"> {/* Asegura mismo ancho */}
        {item.text}
      </p>
    </motion.div>
  ))}
